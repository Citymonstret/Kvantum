...
public class FileUtils
{
    ...
    {
        final Optional<String> cacheEntry = com.plotsquared.iserver.core.ServerImplementation.getImplementation().getCacheManager().getCachedFile( file.toString() );
        ...
        com.plotsquared.iserver.core.ServerImplementation.getImplementation().getCacheManager().setCachedFile( file.toString(), content );
        return content;
    }
