...
@SuppressWarnings("unused") public enum Extension {
    CSS(new String[] {"css"}), HTML(new String[] {"html", "xhtml", "htm", "vm"}), PNG(
        new String[] {"png"}), ICO(new String[] {"ico"}), GIF(new String[] {"gif"}), JPEG(
        new String[] {"jpg", "jpeg"}), ZIP(new String[] {"zip"}), TXT(new String[] {"txt"}), PDF(
        new String[] {"pdf"}), JAVASCRIPT(new String[] {"js",});
