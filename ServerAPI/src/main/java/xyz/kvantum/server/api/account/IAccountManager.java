 ...
 */
@SuppressWarnings("unused") public interface IAccountManager extends KvantumRepository<IAccount, Integer>
{
	...
	@Override default ImmutableList<? extends IAccount> findAllById(@NonNull final Collection<Integer> collection)
	{
	...
	@Override default ImmutableCollection<? extends IAccount> findAll(@NonNull final Integer identifier)
	{
