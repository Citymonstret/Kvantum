...
@SuppressWarnings("ALL") public class KvantumFileUpload extends FileUpload {
    ...
    /**
     * Initialize a new file upload handler that stores the uploaded file in a temporary file, with the default {@link
     * DiskFileItemFactory#DEFAULT_SIZE_THRESHOLD} size threshold
     */
    ...
    /**
     * Initialize a new file upload handler that stores the uploaded file in a temporary file
     *
     ...
     */
    public FileItemIterator getItemIterator(final KvantumFileUploadContext request)
     ...
     */
    public List<FileItem> parseRequest(final KvantumFileUploadContext request)
     ...
     */
    public Map<String, List<FileItem>> parseParameterMap(final KvantumFileUploadContext request)
        throws FileUploadException {
