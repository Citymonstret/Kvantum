...
public class Verifier<T>
{
    ...
    @Builder
    private Verifier(@Singular("withRule") final Collection<Rule<T>> rules, final boolean nullable)
    {
    ...
    /**
     * Verify an object and get a list of all the
     * broken verification rules
     *
     * @param object Object to verify
     * @return Collection of broken rules,
     * empty if the supplied object is valid
     */
