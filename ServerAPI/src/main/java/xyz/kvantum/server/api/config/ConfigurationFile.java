 ...
 */
@SuppressWarnings("unused") public interface ConfigurationFile {
    ...
    /**
     * This will get the object, if it exists, otherwise it returns the default value (and sets the variable)
     *
    ...
    /**
     * This will set a configuration value, in the case that it doesn't exist. Otherwise it will be ignored.
     *
     * @param key   Value identifier
     * @param value Value
     * @param <T>   Value Type
