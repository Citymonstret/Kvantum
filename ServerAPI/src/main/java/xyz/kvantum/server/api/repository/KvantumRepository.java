...
public interface KvantumRepository<T, ID>
{
    ...
    /**
     * Find all objects registered in the repository
     * and sort using a specified sorter
     *
    ...
    /**
     * Find all objects that correspond to a list of
     * given identifiers
     *
    ...
    /**
     * Find all objects that correspond to a list of
     * given identifiers and sort using a specified sorter
     *
     * @param collection Identifiers
     * @param sorter     Sorter
     * @return Immutable collection of matching items
     */
    default ImmutableList<? extends T> findAllByIdSorted(Collection<ID> collection, Sorter<T> sorter)
    {
    ...
    /**
     * Find all objects that correspond to a predicate
     * and sort using a specified sorter
     *
     * @param matcher predicate
     * @param sorter  Sorter
