...
public class View extends RequestHandler {
     ...
     */
    public View(final String pattern, final String internalName, final Map<String, Object> options,
        final ViewReturn viewReturn, final HttpMethod httpMethod) {
        if (options == null) {
     ...
     */
    @SuppressWarnings("ALL") public final <T> T getOption(final String s) {
     ...
     * @return Value
     */
    public final <T> Optional<T> getOptionSafe(final String s) {
     ...
     */
    public final boolean containsOption(final String s) {
     ...
     */
    protected final void applyDefaultHeaders(final Response response) {
        if (!headers.isEmpty()) {
