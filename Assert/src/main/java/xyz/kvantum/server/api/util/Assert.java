...
/**
 * Our custom assertion class. This was solely made to give us more control than we previously had.
 */
@SuppressWarnings({ "WeakerAccess", "unused" }) public final class Assert
{
	...
	/**
	 * Assertion that will pass, and only if, the given number is neither null nor negative (can be 0)
	 *
	...
	/**
	 * Assertion that will pass if a given {@link Validatable} is valid, as stated by: {@link Validatable#isValid()}
	 *
	 ...
	 */
	public static <Exception extends Throwable> void equals(final boolean a, final boolean b, final Exception t)
			throws Exception
	{
		if ( a != b )
		{
	...
	/**
	 * Assertion that will pass if, and only if, the given boolean is false
	 *
	...
	/**
	 * Assertion that will pass if, and only if, the given boolean is true
	 *
	 * @param a Boolean to be tested
	 */
	...
	/**
	 * Assertion that will pass if, and only if, the given integers A and B are equal
	 *
	 * @param a Integer A
	 * @param b Integer B
	 */
	...
	/**
	 * Assertion that will pass if, and only if, the given object is not null
	 *
