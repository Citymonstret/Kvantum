...
public class ExampleAccountRegistration
{
    ...
    public JSONObject onRegister(final AbstractRequest request)
    {
        ...
        } else
        {
            ...
            } else
            {
                ...
                if ( !brokenRules.isEmpty() )
                {
                    ...
                    final JSONArray cause = KvantumJsonFactory.toJsonArray( brokenRules.stream()
                            .map( Rule::getRuleDescription ).collect( Collectors.toList() ) );
                ...
                } else
                {
                    ...
                    final FieldComparator<? extends Account, ? super IAccount> comparator = factory.createMatcher( account );
