	...
	@Override public void setup() throws Exception
	{
		this.applicationStructure.getDatabaseManager().executeUpdate(
				"CREATE TABLE IF NOT EXISTS `sessions` (" + "session_id INTEGER NULL AUTO_INCREMENT,"
						+ "id varchar(64) NOT NULL," + "last_active TIME DEFAULT CURRENT_TIMESTAMP NOT NULL,"
						+ "session_key varchar(64) NOT NULL," + "CONSTRAINT sessions_PK PRIMARY KEY (session_id),"
