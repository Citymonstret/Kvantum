...
@CommandDeclaration(command = "show", usage = "/show c OR /show w", description = "View license and warranty information") public class Show
		extends Command
{
	...
	public boolean onCommand(CommandInstance instance)
	{
		...
		} else
		{
			...
			case "c":
				...
				break;
			case "w":
				lines = new String[] { "6. Trademarks. This License does not grant permission to use the trade\n"
						+ "names, trademarks, service marks, or product names of the Licensor,\n"
						+ "except as required for reasonable and customary use in describing the\n"
						+ "origin of the Work and reproducing the content of the NOTICE file.\n" + "\n"
