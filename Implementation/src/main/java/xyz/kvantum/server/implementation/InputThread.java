...
public final class InputThread extends Thread {
    ...
    InputThread() {
        ...
        ServerImplementation.getImplementation().getCommandManager()
            .createCommand(ServerImplementation.getImplementation().getMetrics());
                    ...
                    switch (result.getCommandResult()) {
                        ...
                        case CommandHandlingOutput.NOT_FOUND:
                            if (result.getClosestMatch() != null) {
                                ServerImplementation.getImplementation().log("Did you mean: /{0}",
                        ...
                        default:
                            ServerImplementation.getImplementation().log(
                                "Unknown command result: " + CommandHandlingOutput
