...
final class HTTPSThread extends Thread
{
    ...
    private final com.github.intellectualsites.iserver.implementation.SocketHandler SocketHandler;
    private final SSLServerSocket sslSocket;

    HTTPSThread(final SSLServerSocket sslSocket, final com.github.intellectualsites.iserver.implementation.SocketHandler SocketHandler)
    {
        super( "SSL-Runner" );
